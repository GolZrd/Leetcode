...
func carFleet(target int, position []int, speed []int) int {
	...
	for _, car := range cars {
		...
		// Проверяем что в стаке больше 2 записей и если предпредпоследнее значение больше
		// или равно только что добавленному, то мы предпоследнее удаляем из стэка, и у нас по итогу в стэке будут
